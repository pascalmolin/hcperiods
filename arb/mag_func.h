...
void arb_bound_func_arf(arb_t m, arb_func_t f, void * params, const arf_t tmin, const arf_t tmax, slong n, slong depth, slong prec);
void arb_bound_func_arb(arb_t m, arb_func_t f, void * params, const arb_t b, slong n, slong depth, slong prec);
