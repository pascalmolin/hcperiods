...
/* integer matrix */
typedef long ** si_mat_t;

si_mat_t si_mat_init(long nr, long nc);
...
void col_addmul(si_mat_t m, long j, long k, long v, long len);
void row_addmul(si_mat_t m, long i, long k, long v, long len);
void col_bezout(si_mat_t m, long j1, long j2, long a, long b, long c, long d, long len);
void row_bezout(si_mat_t m, long i1, long i2, long a, long b, long c, long d, long len);
