...
\begin{lemma}\label{lemma:sxt=sx}
  ...
  \begin{itemize}
   ...
   $s(\xt) \equiv s_b \bmod m$ in the cases $(iii)$ and $(iv)$.
  \end{itemize}
\end{lemma}
 \begin{proof}
...
\begin{rmk}
  The intersection numbers given by Theorem \ref{m-thm:intsec_numb} are independent of the choice of $\xt$ that were made in the proof. This approach works for any $\xt \in V$.
