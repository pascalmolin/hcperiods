...
\begin{document}
  ...
  Consequently, the local monodromy (of the cyclic covering $\pr$) at every $x_k \in X$
  is equal and cyclic of order $m$ and the monodromy group is, up to conjugation, the cyclic group $C_m$. This makes it possible to find explicit generators for the
