...
We sum up the properties of these local branches:
 ...
 \subsection{Cycles and homology}\label{subsec:cycles_homo}
   ...
   \end{defn}
   In $\pi_1(\cu)$
   shifts of elementary cycles are homotopic to cycles that encircle  $a$ in negative and $b$ in positive orientation, once each.
...
\begin{rmk}
    Note that from \eqref{m-eq:diff_cases} it follows that the meromorphic differentials in $\WM$ are homolorphic at all finite points.
\end{rmk}
