...
\begin{document}
  ...
  For general affine algebraic curves, there is an implementation in Maple
  ...
  We also mention the Matlab implementations due to Frauendiener and Klein for hyperelliptic curves \cite{FrauendienerKlein2015}
    and for general affine algebraic curves \cite{FrauendienerKlein2011}.
  ...
  van Wamelen's approach for hyperelliptic curves to general affine algebraic curves.
