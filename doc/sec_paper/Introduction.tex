...
\begin{document}
  ...
  and for general algebraic curves \cite{FrauendienerKlein2011, FrauendienerKlein2016}.
  ...
  In this paper, we rely on the fact that $f$ is separable in several places.
  This restriction could be removed, this is discussed in section \ref{subsec:nonseparable}.
