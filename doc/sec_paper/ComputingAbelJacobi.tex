...
This representation has the following advantages:
 ...
 $(x_0=x_{k_0},x_{k_1},\dots,x_{k_{n-1}},x_{k_t}=x_k)$ in the spanning tree which connects $x_0$ and $x_k$. Thus, the integral splits into
  ...
  \end{align}
  which is  (up to the constants) an elementary integral \eqref{eq:elem_ints}
  ...
  Similar to \eqref{m-eq:uab_preimage} we split up the image of $X$ under $\uaxp$ into subsets, but this time
 \begin{equation}
